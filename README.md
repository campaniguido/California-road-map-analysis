...
The data used were the ones found at the page [Stanford data - California Road Map](http://snap.stanford.edu/data/roadNet-CA.html) , where furthermore data information is presented. The useful data can be found in this repository in the file 'roadnet-ca.txt', which contains couples on nodes linked together. The network features taken into account in this study are the nodes degree, their betweenness and closeness centrality and the nodes clustering coefficient.
...
test.py:
- it ccontains all the function test
## Useful links
